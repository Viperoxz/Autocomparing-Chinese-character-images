...
def test_siamese(image1_path, image2_path, checkpoint_path, threshold, device):
...
if __name__ == "__main__":
    ...
    checkpoint_path = 'models/siamese/best_siamese_model.pth'
    ...
    for i in range(1, 3):  # Giả sử có 2 cặp test: sample1, sample2
        ...
        test_siamese(img1_path, img2_path, checkpoint_path, threshold, device)